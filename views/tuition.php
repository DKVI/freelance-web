...
if ($_SESSION["lang"] == "eng") {
    Post::increaseViews($conn, "135234232fsf332432");
} else {
    Post::increaseViews($conn, "565655gh5664hjk56");
}
?>
<main id="tuition">
    <!-- Tuition Background -->
        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class="col-lg-5 col-sm-10 px-5 py-4" style="background-color: rgb(229, 229, 229,0.8);">
                ...
                <div class="">
                    ...
                    <div class="vn">
                        <p>Đối với khóa học chính thức, MSS sẽ có 02 gói học phí khác nhau. Học viên có thể cân nhắc lựa
                            chọn
                            gói phù hợp nhất với nhu cầu hiện tại của bản thân. Là năm đầu tiên của dự án, MSS đưa ra
                            mức học
                    ...
                    <div class="bg-light">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" class="vn">Truy cập toàn bộ nội dung của khóa học (slides bài giảng,
                                        bài
                                        tập về nhà, bài mẫu)</th>
                                    <th scope="row" class="eng">Access the full course content (lecture slides,
                                        homework,
                                        samples)</th>
                                ...
                                <tr>
                                    <th scope="row" class="vn">Tham gia các buổi thực hành dưới tư cách Quan sát viên
                                    </th>
                                ...
                                <tr>
                                    <th scope="row" class="vn">Tham gia các buổi thực hành dưới tư cách Người thực hành
                                    </th>
