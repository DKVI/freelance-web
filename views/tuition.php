    ...
    <section id="nonprofits-organizations-and-collecting-tuition" style="background-image: url(./assets/imgs/curriculum-16.png); background-size: 100% auto;background-position: center; margin-top:60px">
        <div class=" container d-flex justify-content-center align-items-center p-5">
            <div class="row" style="margin: 8rem 0">
                ...
                <!-- <div class="col-lg-6">
                <p>MSS không xem học phí mà chúng tôi đưa ra cho chương trình là một mức giá cho một sản phẩm dịch vụ được bán ra. MSS xem học phí là một khoản đóng góp của các bạn giúp duy trì hoạt động của dự án.</p>
                <p>Với định hướng hoạt động phi lợi nhuận, toàn bộ học phí thu được sẽ được sử dụng cho việc hoạt động, duy trì, và tiếp tục phát triển MSS.</p>
                <p>Ngoài ra, trên tinh thần hoạt động vì cộng đồng, MSS mong muốn sử dụng các khoản đóng góp này để hỗ trợ sự phát triển của cộng đồng mooting Việt Nam, như xây dựng quỹ khuyến học tài trợ cho các cá nhân muốn tham gia MSS, một kho lưu trữ các tài liệu hữu ích liên quan đến mooting,...</p>
            </div> -->
                <div class="col-lg-6 col-12">
