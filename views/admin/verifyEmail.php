...
<div class="min-vh-100 min-vw-100 d-flex">
    <form method="post" action="../controllers/handleSendMail.php" class="form d-flex w-50 m-auto rounded-3 shadow overflow-hidden" style="height: 80%">
        ...
        <div class="w-50 d-flex">
            <div class="w-75 m-auto d-flex flex-column ">
                ...
                <div class="form-group">
                    <div class="pb-2">
                        <input id="email" type="email" name="email" class="form-control shadow-sm  py-2 px-3" placeholder="Enter admin's email" required>
                    </div>
                </div>
