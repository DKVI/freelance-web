    ...
    <div class="" style="padding: 0 150px">
        <form class="form-post" action="../controllers/handleUpdatePost.php?id=<?php echo $post->id ?>"
            ...
            <div class="d-flex justify-content-end pb-4" style="gap: 16px">
                <button type="button" class="btn btn-danger <?php echo $post->type === "static" ? "d-none" : null ?>"
                ...
                <button type="submit"
                    class="btn btn-primary preview-btn <?php echo $post->type === "static" ? 'd-none' : null ?>">Preview</button>
