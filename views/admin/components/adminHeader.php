<nav class="p-3 admin-header d-flex navbar navbar-expand-lg justify-content-between "
    ...
    <div class="d-flex justify-content-between" style="width: 30%;">
        ...
        <a class="text-white text-decoration-none" style="cursor: pointer">News</a>
        <a class="text-white text-decoration-none" style="cursor: pointer">Events</a>
        <a class="text-white text-decoration-none" style="cursor: pointer">FAQs</a>
    </div>
