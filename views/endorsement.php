            ...
            <div id="testimonials" class="carousel slide padding color-section" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./assets/imgs/endorsement-1.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-2.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-3.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-4.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-5.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-6.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-7.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-8.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-9.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-10.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-11.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-12.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
    ...
    <section id="review-from-mentee-mobile" class="background-full d-none"
        ...
        <div class="container">
            ...
            <div id="testimonials" class="carousel slide padding color-section" data-bs-ride="carousel" style="">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./assets/imgs/endorsement-mobile-1.png" alt="mss-endorsement">
                    </div>
                    <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-mobile-2.png" alt="mss-endorsement">
                    </div>
                    <!-- <div class="carousel-item">
                        <img src="./assets/imgs/endorsement-3.png" alt="mss-endorsement">
                    </div>
