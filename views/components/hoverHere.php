<div class="position-fixed z-3 hover-here-component text-center" style="width: 100px; height: 100px; top: 10%; right: 20%; filter: drop-shadow(#cccc 1px 1px 4px); ">
...
<script>
    ...
    navBar.onmouseout = () => {
        hoverHereBtn.style.opacity = 0;
        hoverHereBtn.style.display = "block";
    }
</script>