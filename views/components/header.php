...
<div>
    <div class="logo-area container-fluid">
        <nav class=" navbar header-container navbar-expand-xl navbar-light fixed-top d-flex justify-content-between"
            id="mainNav">
                    ...
                    <div class="collapse navbar-collapse" id="navResponsive">
                        <ul class="navbar-nav vn">
                            <li class="nav-item dropdown custom-scrollbar">
                                ...
                                <ul style="width: auto; right: 0" class="shadow-lg dropdown-menu dropdown-menu-light">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/about#a-message-from-our-founder' ?>">Lời ngỏ
                                            từ
                                            Nhà
                                            sáng
                                            lập</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul style="width: auto; right: 0" class="shadow-lg dropdown-menu dropdown-menu-light">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#about-the-program' ?>">Về
                                            chương trình</a></li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#about-class-rules' ?>">Về
                                            nội quy trong lớp</a></li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#about-the-package' ?>">Về
                                            gói học</a></li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                    ...
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#participant-prohibitions' ?>">Hành vi
                                            nghiêm cấm</a></li>
                        ...
                        ">
                                ...
                                <ul style="width: auto; right: 0" class="shadow-lg dropdown-menu dropdown-menu-light">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/about#a-message-from-our-founder' ?>">A
                                            message
                                            from our Founder</a></li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/about#our-mission' ?>">Our
                                            Mission</a></li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/about#symbol-and-title-of-MSS' ?>">Our
                                            Emblem</a>
                                    </li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/about#philosophy' ?>">Philosophy</a>
                                    </li>
                                    <hr class="dropdown-divider">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul style="width: auto; right: 0" class="shadow-lg dropdown-menu dropdown-menu-light">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/curriculum#what-is-mooting' ?>">What
                                            is
                                            Mooting?</a></li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                    ...
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/curriculum#end-of-course-sessions' ?>">Closing
                                            session</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul style="width: auto;  right: 0" class="shadow-lg dropdown-menu dropdown-menu-light">
                                    ...
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/tuition#nonprofits-organizations-and-collecting-tuition' ?>">Not-for-profit
                            ...
                            <li class="nav-item dropdown endorsement">
                                <a href="<?php echo BASE_URL . '/endorsement' ?>"
                                    class="nav-link dropdown-toggle ">Endorsement</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">FAQ</a>
                                <ul style="width: auto; right: 0" class="shadow-lg dropdown-menu dropdown-menu-light">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#about-the-program' ?>">About the
                                            program</a>
                                    </li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#about-class-rules' ?>">About
                                            class rules</a>
                                    </li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#about-the-package' ?>">About the
                                            package</a>
                                    </li>
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                    ...
                                    <hr class="dropdown-divider">
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL . '/faq#participant-prohibitions' ?>">Prohibited
                                            act</a>
                                    </li>
                                </ul>
                            </li>
