...
<div class="logo-area container-fluid fixed-top">
        <nav class=" navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="menu-nav text-center justify-content-center align-items-center col-lg-4">
                ...
                <button class="navbar-toggler btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#navResponsive"
        ...
        <div class="d-flex language fixed-top">
            <a class="text-decoration-none"
                ...
                style="cursor:pointer; color: inherit;"><img src="././assets/imgs/vietnam.png" alt="vietnam-flag" class="lang-flag"></a> <span class="px-2">|</span>
            <a class="text-decoration-none"
                href="<?php echo $uri = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) . "?language=eng"; ?>"
                style="cursor:pointer; color: inherit;"><img src="././assets/imgs/united-kingdom.png" alt="united-kingdom-flag" class="lang-flag"></a>
=======
<div class="header d-inline-flex justify-content-between fixed-top px-5 align-items-center logo-area" style="z-index: 0">
...
<!-- NAVBAR -->
<nav class=" header navbar navbar-expand-lg fixed-top navbar-dark" id="mainNav" style="z-index: 0">
