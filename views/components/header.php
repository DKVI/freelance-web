<!-- LOGO AREA -->
<div class="d-inline-flex justify-content-between fixed-top px-5 align-items-center logo-area">
    <img src="././assets/imgs/small-logo.png" id="top-logo"alt="MSS-logo">
    <h6 class="d-block">Vie | Eng</h6>
</div>
<!-- NAVBAR -->
<nav class="navbar navbar-expand-lg fixed-top bg-body-tertiary" id="mainNav">
    <div class="container">
