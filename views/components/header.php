...
<div class="logo-area container-fluid mt-2 fixed-top">
    <nav class=" navbar navbar-expand-lg navbar-light fixed-top mt-5" id="mainNav">
        <div class="menu-nav text-center justify-content-center align-items-center col-lg-4" style="padding-right: 32px;">
...
<!-- NAVBAR -->
<div class="d-flex justify-content-between fixed-top pt-3" style="width: 100vw; background-color: rgba(229, 229, 229, 0.5);">
